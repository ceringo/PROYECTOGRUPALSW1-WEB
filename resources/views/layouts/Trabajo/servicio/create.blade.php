             ...
             <div class="box box-primary col-md-12 box-gris">
                 ...
                 <div class="box-header with-border my-box-header">    
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/trabajo/servicio') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            @include ('layouts/Trabajo.servicio.form', ['formMode' => 'create'])
